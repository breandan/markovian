...
To remove a dimension from a joint distribution $P(X, Y)$ we can \textit{marginalize}, or sum over all conditionals. The resulting distribution is called a \textit{marginal distribution}:
